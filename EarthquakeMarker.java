...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	pg.fill(255,255,255);
	pg.rect(x, y-10, pg.textWidth((this.getProperty("title")+","+this.getProperty("magnitude"))+5), 15);
	pg.fill(0,0,0);
	pg.text(this.getProperty("title").toString()+","+this.getProperty("magnitude"),x+5,y);
